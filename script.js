...
// const cycling = new Cycling([39, -12], 27, 95, 238);
...
class App {
  ...
  //When we convert the objects to string and then back to objects, we lose the prototype chain, they are just regular objects
